...
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="crunchybridgeclusters",verbs={list,watch}
...
// +kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="crunchybridgeclusters/finalizers",verbs={update}
...
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="crunchybridgeclusters/status",verbs={patch,update}
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="crunchybridgeclusters/finalizers",verbs={patch,update}
