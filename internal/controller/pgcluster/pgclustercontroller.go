...
func (c *Controller) onDelete(obj interface{}) {
	...
	keepBackups := isAnnotation(cluster, string(config.ANNOTATION_CLUSTER_KEEP_BACKUPS))
	keepData := isAnnotation(cluster, string(config.ANNOTATION_CLUSTER_KEEP_DATA))
...
func isAnnotation(cluster *crv1.Pgcluster, key string) (isAnnotation bool) {
