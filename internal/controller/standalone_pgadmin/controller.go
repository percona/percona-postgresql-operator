...
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="pgadmins",verbs={get}
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="pgadmins/status",verbs={patch}
...
// +kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="pgadmins/finalizers",verbs={update}
