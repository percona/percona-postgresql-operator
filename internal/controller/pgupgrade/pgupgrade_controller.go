...
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="pgupgrades",verbs={list,watch}
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="postgresclusters",verbs={list,watch}
...
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="pgupgrades",verbs={list}
...
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="pgupgrades",verbs={get}
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="pgupgrades/status",verbs={patch}
//+kubebuilder:rbac:groups="batch",resources="jobs",verbs={delete}
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="postgresclusters",verbs={get}
//+kubebuilder:rbac:groups="upstream.pgv3.percona.com",resources="postgresclusters/status",verbs={patch}
