...
const (
	...
	// K8SPG-771
	// DisableWALArchiveRecoveryAnnotation is an annotation used to disable WAL recovery on startup.
	DisableWALArchiveRecoveryAnnotation = annotationPrefix + "disable-wal-archive-recovery"
)
