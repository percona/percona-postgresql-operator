...
// Validate validates this version product response
...
func (m *VersionProductResponse) validateVersions(formats strfmt.Registry) error {
...
func (m *VersionProductResponse) contextValidateVersions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VersionProductResponse) UnmarshalBinary(b []byte) error {
	var res VersionProductResponse
