...
// Validate validates this version version response
...
func (m *VersionVersionResponse) validateVersions(formats strfmt.Registry) error {
...
func (m *VersionVersionResponse) contextValidateVersions(ctx context.Context, formats strfmt.Registry) error {
...
func (m *VersionVersionResponse) UnmarshalBinary(b []byte) error {
	var res VersionVersionResponse
