...
#export IMAGE_BACKREST=${IMAGE_BACKREST:-"perconalab/percona-pgbackrest"}
export IMAGE_BACKREST=${IMAGE_BACKREST:-"ademajazzserve/pgbackrest:test-9"} # TODO: remove before merge
