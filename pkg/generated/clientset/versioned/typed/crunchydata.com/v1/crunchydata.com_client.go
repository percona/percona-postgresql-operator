...
func NewForConfig(c *rest.Config) (*CrunchydataV1Client, error) {
	...
	return &CrunchydataV1Client{client}, nil
}

// NewForConfigOrDie creates a new CrunchydataV1Client for the given config and
...
func New(c rest.Interface) *CrunchydataV1Client {
	return &CrunchydataV1Client{c}
}
