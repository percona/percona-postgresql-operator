...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PGTDEFileSpec) DeepCopyInto(out *PGTDEFileSpec) {
	*out = *in
	out.KeySecret = in.KeySecret
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PGTDEFileSpec.
func (in *PGTDEFileSpec) DeepCopy() *PGTDEFileSpec {
	if in == nil {
		return nil
	}
	out := new(PGTDEFileSpec)
	in.DeepCopyInto(out)
	return out
}
