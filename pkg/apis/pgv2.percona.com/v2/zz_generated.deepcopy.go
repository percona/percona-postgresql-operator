...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *PVCSnapshotRef) DeepCopyInto(out *PVCSnapshotRef) {
	*out = *in
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new PVCSnapshotRef.
func (in *PVCSnapshotRef) DeepCopy() *PVCSnapshotRef {
	if in == nil {
		return nil
	}
	out := new(PVCSnapshotRef)
	in.DeepCopyInto(out)
	return out
}
...
func (in *SnapshotStatus) DeepCopyInto(out *SnapshotStatus) {
	*out = *in
	...
	if in.WALVolume != nil {
		in, out := &in.WALVolume, &out.WALVolume
		*out = new(PVCSnapshotRef)
		**out = **in
	}
	if in.TablespaceVolumes != nil {
		in, out := &in.TablespaceVolumes, &out.TablespaceVolumes
		*out = make(map[string]PVCSnapshotRef, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
